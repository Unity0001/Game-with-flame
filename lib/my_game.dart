...
import 'package:flame_game/circle_rotation.dart';
...
class MyGame extends FlameGame
  ...
  void _generateGameComponents() {
    ...
    world.add(
      CircleRotator(position: Vector2(0, -750), size: Vector2(180, 180)),
    );
    ...
    world.add(
      CircleRotator(position: Vector2(0, -1150), size: Vector2(180, 180)),
    );
    world.add(
      CircleRotator(position: Vector2(0, -1150), size: Vector2(210, 210)),
    );
